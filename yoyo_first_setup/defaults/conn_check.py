...
@Gtk.Template(resource_path='/io/github/yoyo-os/FirstSetup/gtk/default-conn-check.ui')
class YoyoDefaultConnCheck(Adw.Bin):
    __gtype_name__ = 'YoyoDefaultConnCheck'
    ...
    def __start_conn_check(self):
        def async_fn():
            if "YOYO_SKIP_CONN_CHECK" in os.environ:
                return True

            try:
                urlopen("https://bing.com", timeout=1)
                return True
            except:
                return False
