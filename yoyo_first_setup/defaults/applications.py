...
@Gtk.Template(resource_path='/io/github/yoyo-os/FirstSetup/gtk/layout-applications.ui')
class YoyoLayoutApplications(Adw.Bin):
    __gtype_name__ = 'YoyoLayoutApplications'
            ...
            for app in item["applications"]:
                ...
                try:
                    if app[package_manager]:
                        ...
                        _app_icon = Gtk.Image.new_from_resource("/io/github/yoyo-os/FirstSetup/assets/bundle-app-icons/" + app["icon"] + ".png")
