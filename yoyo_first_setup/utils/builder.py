...
from yoyo_first_setup.utils.recipe import RecipeLoader

from yoyo_first_setup.defaults.conn_check import YoyoDefaultConnCheck
from yoyo_first_setup.defaults.welcome import YoyoDefaultWelcome
from yoyo_first_setup.defaults.theme import YoyoDefaultTheme
from yoyo_first_setup.defaults.user import YoyoDefaultUser
from yoyo_first_setup.defaults.hostname import YoyoDefaultHostname

from yoyo_first_setup.layouts.preferences import YoyoLayoutPreferences
from yoyo_first_setup.layouts.yes_no import YoyoLayoutYesNo
from yoyo_first_setup.defaults.applications import YoyoLayoutApplications
...
templates = {
    "conn-check": YoyoDefaultConnCheck,
    "welcome": YoyoDefaultWelcome,
    "theme": YoyoDefaultTheme,
    "user": YoyoDefaultUser,
    "hostname": YoyoDefaultHostname,
    "preferences": YoyoLayoutPreferences,
    "yes-no": YoyoLayoutYesNo,
    "applications": YoyoLayoutApplications
}
