...
from yoyo_first_setup.utils.builder import Builder
from yoyo_first_setup.utils.parser import Parser
from yoyo_first_setup.utils.processor import Processor
from yoyo_first_setup.utils.run_async import RunAsync

from yoyo_first_setup.views.progress import YoyoProgress
from yoyo_first_setup.views.done import YoyoDone
from yoyo_first_setup.views.post_script import YoyoPostScript


@Gtk.Template(resource_path='/io/github/yoyo-os/FirstSetup/gtk/window.ui')
class YoyoWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, post_script: str, user: str, new_user: bool=False, **kwargs):
        ...
        if post_script:
            ...
            # system views
            self.__view_done = YoyoDone(self, reboot=False,
    ...
    def __build_post_script_ui(self, post_script):
        self.__view_post_script = YoyoPostScript(self, post_script)
    ...
    def __on_page_changed(self, *args):
        ...
        res = Processor.get_setup_commands(
            self.recipe.get("log_file", "/tmp/yoyo_first_setup.log"), 
